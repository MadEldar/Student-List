...
<div class="wrapper">
                            ...
                            <table id="table-brand" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <a data-toggle="modal" data-target="#modal-edit-brand"><i class="far fa-edit"></i></a>
                                        <a data-toggle="modal" data-target="#modal-delete-brand"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @empty
                                    <p>Không có cột</p>
    ...
    <div class="modal fade" id="modal-delete-brand">
        <div class="modal-dialog modal-lg">
            <form class="modal-content" action="{{ url('/admin/brands/delete') }}" method="post">
                @csrf
                <div class="modal-header">
